...
namespace CollectionsAndLinq.DAL.Migrations
{
    ...
    [Migration("20230216081050_AddedIndexesAndRequired")]
    partial class AddedIndexesAndRequired
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CollectionsAndLinq.DAL.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AuthorId = 1,
                            CreatedAt = new DateTime(2023, 2, 16, 10, 10, 49, 873, DateTimeKind.Local).AddTicks(2249),
            ...
            modelBuilder.Entity("CollectionsAndLinq.DAL.Entities.Task", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 2, 14, 10, 10, 49, 873, DateTimeKind.Local).AddTicks(2280),
            ...
            modelBuilder.Entity("CollectionsAndLinq.DAL.Entities.Team", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 2, 16, 10, 10, 49, 873, DateTimeKind.Local).AddTicks(2179),
                            Name = "Best Team"
                        });
                });
            ...
            modelBuilder.Entity("CollectionsAndLinq.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "Vollan",
                            LastName = "De Mort",
                            RegisteredAt = new DateTime(2023, 2, 13, 10, 10, 49, 873, DateTimeKind.Local).AddTicks(2265),
                            TeamId = 1
                        });
                });
